    ...
    <div className="max-w-3xl mx-auto px-4 pb-16">
      ...
      {!viewOnly && (
        <div className="mt-8 pt-6 border-t border-border-subtle flex flex-col sm:flex-row gap-2 items-center justify-center flex-wrap">
          ...
          <Link href="/" className="rounded-lg border border-dashed border-border-dashed text-fg-muted hover:text-fg-primary px-4 py-2 text-sm font-semibold uppercase tracking-wider transition-colors">
            ← Home
          </Link>
        </div>
      )}
